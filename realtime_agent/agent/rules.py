        ...
        for alert in alerts:
            ...
            if alert.code == "HIGH_CPU":
                ...
                reqs.append(
                    ...
                    params={"safe_mode": safe_mode, "client_assistant": alert.context.get("client_assistant", {})},
                ...
                reqs.append(
                    ActionRequest(
                        ...
                        reason=alert.message,
                        params={"pid": alert.context.get("pid"), "name": alert.context.get("name"), "client_assistant": alert.context.get("client_assistant", {})},
                        severity=alert.severity,
                        recurrence_count=rec,
            ...
            candidates.append(
                ActionRequest(
                    ...
                    params={
                        ...
                        "client_assistant": alert.context.get("client_assistant", {}),
                    },
                    severity=alert.severity,
