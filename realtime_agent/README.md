...
- Assistente de comunicação com cliente (fase inicial):
  - mensagem explicativa por incidente com responsável principal
  - sugestões operacionais seguras (ex.: fechar abas/processos secundários de baixo risco)
  - contexto enviado junto aos eventos para exibição no painel
